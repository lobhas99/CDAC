...
OR
@Before("execution (Vendor com.app.bank.*.*(double))")
public void logMessages()
{
 //add logging call here. (log.warn("a warning here!!!!"));
}

Meaning : SC(Spring container) will automatically intercept , all methods , from all the clasess , from com.app.bank pkg , having ret type=Vendor n arg type : double  , to insert logging advice , before method exec.
