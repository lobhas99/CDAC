...
public class Product extends BaseEntity {
	...
	public int hashCode() {
		...
		result = prime * result + Objects.hash(brand, category, colour, createdAt, description, discountPercent,
				discountedPrice, imageUrl, numRatings, price, quantity, ratings, reviews, sizes, title);
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(brand, other.brand) && Objects.equals(category, other.category)
				&& Objects.equals(colour, other.colour) && Objects.equals(createdAt, other.createdAt)
				&& Objects.equals(description, other.description) && discountPercent == other.discountPercent
				&& discountedPrice == other.discountedPrice && Objects.equals(imageUrl, other.imageUrl)
