...
import com.fashionsuperior.service.UserService;
...
public class OrderController {
	...
	@GetMapping("/{orderId}")
	public ResponseEntity< Order> findOrderHandler(@PathVariable("orderId") Long orderId, @RequestHeader("Authorization") 
	String jwt) throws OrderException, UserException{
